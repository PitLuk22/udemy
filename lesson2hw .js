...
var appData = {
    ...
    chooseInCome: function () {
        let items = prompt("Что еще может приносить Вам дополнительный доход? (Перечислите через запятую)", " ");
...
for (let key in appData) {
    console.log('Наша программа включает в себя значения: ' + key + ' - ' + appData[key]);
};